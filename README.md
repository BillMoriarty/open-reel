...
I have a large local music library and wanted a player that worked the way I actually listen: actually native, started fast, had real search, and looked like it belonged on a desktop. And somewhere to write notes about what I was hearing.
